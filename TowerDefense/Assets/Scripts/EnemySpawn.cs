...
public class EnemySpawn : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemyWavePatern = new EnemyWave[]
        {
            new EnemyWave(1, 1, false, false), new EnemyWave(1, 5, false, false), new EnemyWave(2, 1, false, false),
            new EnemyWave(1, 10, false, false), new EnemyWave(1, 1, true, false), new EnemyWave(2, 3, false, false),
            new EnemyWave(3, 1, false, false), new EnemyWave(2, 5, false, false), new EnemyWave(3, 3, false, false),
            new EnemyWave(1, 2, false, true), new EnemyWave(1, 4, true, false), new EnemyWave(3, 5, false, false),
            new EnemyWave(1, 3, true, true), new EnemyWave(3, 3, false, true), new EnemyWave(3, 6, true, false)
        };
        wave = 0;
    ...
    void Update()
    {
        ...
        if (Time.time - lastWave > delay)
        {
            ...
            if (!isDemo)
            {
                GameManager.singleton.NextWave();
